...
--
-- Host: localhost:8889
-- Generation Time: May 18, 2026 at 07:05 PM
...
(999, 'Test Customer d.o.o. 123', 'Test Last name', 'Test First name', '+386 41 123 321', 'Titova ulica 71', NULL, 'Ljubljana', 'Ljubljana', '1000', 'Slovenia', 1370, 199.50);
...
--
-- Table structure for table `pozari`
--

CREATE TABLE `pozari` (
  `idpozar` int NOT NULL,
  `obcina` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `x` double DEFAULT NULL,
  `y` double DEFAULT NULL,
  `lokacija` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Leto` int DEFAULT NULL,
  `Mesec` int DEFAULT NULL,
  `Dan` int DEFAULT NULL,
  `vzrok_nastanka_pozara` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `razvojna_faza_gozda` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `drevesna_vrsta` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `lega` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nadmorska_visina` int DEFAULT NULL,
  `polpokr_naziv` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `vreme_sonce` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `vreme_veter` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `vreme_padavine` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `povrsina_gozdovi_in_grmisca` decimal(10,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `pozari`
--

INSERT INTO `pozari` (`idpozar`, `obcina`, `x`, `y`, `lokacija`, `Leto`, `Mesec`, `Dan`, `vzrok_nastanka_pozara`, `razvojna_faza_gozda`, `drevesna_vrsta`, `lega`, `nadmorska_visina`, `polpokr_naziv`, `vreme_sonce`, `vreme_veter`, `vreme_padavine`, `povrsina_gozdovi_in_grmisca`) VALUES
(313980, 'SEŽANA', 412537, 72768, 'Grič', 2022, 1, 17, 'Namerni požig', 'Debeljak', 'črni bor', 'SV', 370, 'Pobočje', 'Neznano', 'Neznano', 'Neznano', 0.00),
(314085, 'ILIRSKA BISTRICA', 444570, 43227, 'Perilo', 2022, 1, 19, 'Neznani vzroki', 'Drogovnjak', 'črna jelša', 'J', 466, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.01),
(314162, 'ŠMARJE PRI JELŠAH', 540485, 125824, 'Bekuš', 2022, 1, 21, 'Kmetijska opravila', 'Debeljak', 'navadna bukev', 'JZ', 367, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.34),
(314214, 'LJUBLJANA', 458910, 102109, 'Koseški boršt', 2022, 1, 22, 'Namerni požig', 'Debeljak', 'navadna smreka', 'SZ', 308, 'Ravnina', 'Sončno', 'Mirno ozračje', 'Suho', 0.00),
(314492, 'PODVELKA', 525439, 160034, 'Velka', 2022, 1, 28, 'Komunikacije (vlaki, el. vodi, itd.)', 'Drogovnjak', 'navadna smreka', 'V', 300, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.00),
(314604, 'MIREN-KOSTANJEVICA', 398234, 78297, 'Kraje', 2022, 1, 30, 'Neznani vzroki', 'Debeljak', 'graden', 'JV', 357, 'Ravnina', 'Pretežno sončno', 'Mirno ozračje', 'Suho', 0.04),
(315137, 'GORENJA VAS-POLJANE', 435236, 111449, 'Rovičar', 2022, 2, 9, 'Kmetijska opravila', 'Raznomerno (posamično-šopasto)', 'navadna smreka', 'JV', 594, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.07),
(315150, 'ROGATEC', 556628, 122615, 'Gobec', 2022, 2, 9, 'Kmetijska opravila', 'Drogovnjak', 'graden', 'S', 270, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.28),
(315151, 'TRŽIČ', 450223, 136413, 'Grahovše (Pr Anžic)', 2022, 2, 9, 'Kmetijska opravila', 'Debeljak', 'navadna smreka', 'J', 810, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.14),
(315152, 'ŽALEC', 511770, 131474, 'Koreza', 2022, 2, 9, 'Kmetijska opravila', 'Debeljak', 'graden', 'J', 389, 'Pobočje', 'Sončno', 'Vetrovno', 'Suho', 0.11),
(315359, 'GORENJA VAS-POLJANE', 436629, 105447, 'Bačne - Potokar', 2022, 2, 13, 'Namerni požig', 'Sestoj v obnovi', 'rdeči bor', 'J', 454, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.49),
(315474, 'ČRNA NA KOROŠKEM', 487833, 147661, 'Črna na Koroškem', 2022, 2, 15, 'Neznani vzroki', 'Debeljak', 'navadna smreka', 'JV', 982, 'Pobočje', 'Oblačno', 'Mirno ozračje', 'Deževno', 0.00),
(316097, 'ILIRSKA BISTRICA', 440786, 44116, 'Sveti Rok', 2022, 2, 27, 'Komunikacije (vlaki, el. vodi, itd.)', 'Drogovnjak', 'gladki bor', 'JZ', 412, 'Pobočje', 'Neznano', 'Močno vetrovno', 'Suho', 0.02),
(316147, 'HRPELJE-KOZINA', 415035, 49797, 'Smelavc', 2022, 2, 28, 'Kmetijska opravila', 'Drogovnjak', 'maklen', 'JZ', 372, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.10),
(316182, 'ILIRSKA BISTRICA', 442641, 45430, 'Mrzlice', 2022, 2, 28, 'Kmetijska opravila', 'Drogovnjak', 'gladki bor', 'S', 409, 'Ravnina', 'Sončno', 'Vetrovno', 'Suho', 0.01),
(316332, 'ŽELEZNIKI', 428859, 117805, 'Čemažar', 2022, 3, 3, 'Kmetijska opravila', 'Pionirski gozd z grmišči', 'navadna breza', 'J', 986, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.04),
(316414, 'SEŽANA', 413484, 68879, 'Za grižo', 2022, 3, 4, 'Kmetijska opravila', 'Debeljak', 'graden', 'S', 326, 'Ravnina', 'Neznano', 'Neznano', 'Neznano', 0.82),
(316431, 'POLJČANE', 543322, 127477, 'Zalonč', 2022, 3, 4, 'Kmetijska opravila', 'Sestoj v obnovi', 'navadna bukev', 'SV', 387, 'Pobočje', 'Pretežno sončno', 'Vetrovno', 'Suho', 4.39),
(316458, 'HRPELJE-KOZINA', 423997, 52060, 'Hrib', 2022, 3, 4, 'Kmetijska opravila', 'Debeljak', 'pravi kostanj', 'J', 790, 'Pobočje', 'Pretežno sončno', 'Zmerno vetrovno', 'Suho', 0.02),
(316486, 'HRPELJE-KOZINA', 428906, 43227, 'Gnojine', 2022, 3, 5, 'Namerni požig', 'Drogovnjak', 'rdeči bor', 'S', 581, 'Ravnina', 'Neznano', 'Neznano', 'Suho', 0.37),
(316548, 'KRANJ', 450371, 124837, 'Kokrica', 2022, 3, 6, 'Obiskovalci gozda (turisti, otroci, ipd.)', 'Mladovje', 'navadna lipa', 'Ravnina', 410, 'Ravnina', 'Pretežno sončno', 'Vetrovno', 'Suho', 0.01),
(316567, 'MAJŠPERK', 557383, 131476, 'Durič', 2022, 3, 6, 'Kmetijska opravila', 'Debeljak', 'navadna bukev', 'Z', 390, 'Pobočje', 'Pretežno sončno', 'Zmerno vetrovno', 'Suho', 0.08),
(316641, 'LJUBLJANA', 458667, 105119, 'Pržanj', 2022, 3, 7, 'Namerni požig', 'Mladovje', 'navadna smreka', 'J', 344, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.04),
(316683, 'KOPER', 406206, 45504, 'Mihati', 2022, 3, 8, 'Kmetijska opravila', 'Debeljak', 'topol', 'Z', 8, 'Pobočje', 'Neznano', 'Neznano', 'Neznano', 0.07),
(316693, 'SEŽANA', 414885, 64143, 'Renčelice', 2022, 3, 8, 'Kmetijska opravila', 'Sestoj v obnovi', 'puhasti hrast', 'JZ', 338, 'Ravnina', 'Neznano', 'Neznano', 'Neznano', 0.07),
(316789, 'LJUBLJANA', 458728, 105229, 'Pržanj', 2022, 3, 10, 'Namerni požig', 'Debeljak', 'rdeči bor', 'JV', 358, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.58),
(316839, 'JEZERSKO', 461856, 141727, 'Karavanke', 2022, 3, 10, 'Gozdarska opravila', 'Debeljak', 'navadna smreka', 'JV', 1253, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.13),
(316851, 'ILIRSKA BISTRICA', 436951, 45090, 'Klivnik', 2022, 3, 10, 'Kmetijska opravila', 'Drogovnjak', 'gladki bor', 'SV', 438, 'Pobočje', 'Neznano', 'Neznano', 'Neznano', 0.13),
(316885, 'RENČE-VOGRSKO', 398610, 86465, 'Vižin', 2022, 3, 11, 'Neznani vzroki', 'Panjevec', 'robinija', 'V', 105, 'Vznožje', 'Neznano', 'Mirno ozračje', 'Suho', 0.01),
(316901, 'ŽALEC', 513092, 127488, 'Šip', 2022, 3, 11, 'Namerni požig', 'Drogovnjak', 'navadna bukev', 'J', 401, 'Pobočje', 'Sončno', 'Močno vetrovno', 'Suho', 0.30),
(316928, 'ILIRSKA BISTRICA', 438517, 51651, 'Merejski hrib', 2022, 3, 11, 'Kmetijska opravila', 'Drogovnjak', 'trepetlika', 'JZ', 474, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.09),
(316937, 'ILIRSKA BISTRICA', 437122, 45360, 'Voglar', 2022, 3, 11, 'Neznani vzroki', 'Drogovnjak', 'cer', 'JZ', 454, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.13),
(316989, 'ZAVRČ', 579829, 135408, 'Sveti Janez', 2022, 3, 12, 'Kmetijska opravila', 'Debeljak', 'navadna bukev', 'V', 326, 'Pobočje', 'Sončno', 'Vetrovno', 'Suho', 0.03),
(317014, 'METLIKA', 523183, 57509, 'Lipoš', 2022, 3, 12, 'Kmetijska opravila', 'Drogovnjak', 'pravi kostanj', 'JV', 248, 'Vznožje', 'Sončno', 'Mirno ozračje', 'Suho', 0.21),
(317016, 'ROGAŠKA SLATINA', 546943, 124611, 'Čača vas', 2022, 3, 12, 'Kmetijska opravila', 'Drogovnjak', 'graden', 'JV', 342, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.31),
(317021, 'TRBOVLJE', 500522, 107095, 'Šklendrovec', 2022, 3, 12, 'Industrijska dejavnost', 'Debeljak', 'navadna smreka', 'S', 395, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 4.64),
(317050, 'ŠEMPETER-VRTOJBA', 396082, 86794, 'Bazara', 2022, 3, 12, 'Kmetijska opravila', 'Panjevec', 'robinija', 'Z', 116, 'Vznožje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.01),
(317085, 'GORENJA VAS-POLJANE', 429540, 111126, 'Potočnik', 2022, 3, 13, 'Neznani vzroki', 'Drogovnjak', 'navadna bukev', 'V', 700, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.09),
(317109, 'METLIKA', 519062, 63056, 'Jugorje pri Metliki', 2022, 3, 13, 'Namerni požig', 'Pionirski gozd z grmišči', 'črna jelša', 'JV', 568, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.05),
(317112, 'KAMNIK', 469310, 123197, 'Stranjski potok', 2022, 3, 13, 'Obiskovalci gozda (turisti, otroci, ipd.)', 'Sestoj v obnovi', 'navadna bukev', 'J', 439, 'Pobočje', 'Sončno', 'Vetrovno', 'Suho', 0.02),
(317116, 'DRAVOGRAD', 503929, 160314, 'Kotel', 2022, 3, 13, 'Neznani vzroki', 'Debeljak', 'navadna smreka', 'JV', 670, 'Pobočje', 'Sončno', 'Vetrovno', 'Suho', 2.03),
(317130, 'HRPELJE-KOZINA', 428294, 42465, 'Sveti  Nikolaj', 2022, 3, 13, 'Neznani vzroki', 'Drogovnjak', 'rdeči bor', 'SV', 615, 'Ravnina', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.08),
(317135, 'LJUBLJANA', 458853, 101826, 'Veliki Rakovnik', 2022, 3, 13, 'Namerni požig', 'Sestoj v obnovi', 'navadna smreka', 'Z', 304, 'Ravnina', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.08),
(317138, 'ŽALEC', 513480, 128552, 'Kovač', 2022, 3, 13, 'Kmetijska opravila', 'Debeljak', 'navadna bukev', 'V', 302, 'Pobočje', 'Sončno', 'Močno vetrovno', 'Suho', 1.24),
(317147, 'RENČE-VOGRSKO', 398340, 83250, 'Lukežiči', 2022, 3, 13, 'Neznani vzroki', 'Panjevec', 'robinija', 'JZ', 86, 'Pobočje', 'Sončno', 'Vetrovno', 'Suho', 0.03),
(317160, 'KAMNIK', 469462, 122464, 'Kamniška Bistrica', 2022, 3, 13, 'Obiskovalci gozda (turisti, otroci, ipd.)', 'Sestoj v obnovi', 'navadna bukev', 'SV', 428, 'Vznožje', 'Sončno', 'Vetrovno', 'Suho', 0.01),
(317165, 'LJUBLJANA', 458903, 101791, 'Za Mošenico', 2022, 3, 13, 'Namerni požig', 'Debeljak', 'navadna smreka', 'JZ', 306, 'Ravnina', 'Sončno', 'Vetrovno', 'Suho', 0.02),
(317182, 'TREBNJE', 501149, 86959, 'Vejar', 2022, 3, 13, 'Namerni požig', 'Sestoj v obnovi', 'navadna bukev', 'Z', 290, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.62),
(317213, 'LJUBLJANA', 460738, 101745, 'Tivolski vrh', 2022, 3, 14, 'Namerni požig', 'Sestoj v obnovi', 'dob', 'V', 380, 'Pobočje', 'Pretežno sončno', 'Vetrovno', 'Suho', 0.47),
(317225, 'KOPER', 406221, 47334, 'Druga Škofija', 2022, 3, 14, 'Namerni požig', 'Debeljak', 'črni bor', 'J', 46, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.12),
(317318, 'KOČEVJE', 490103, 56864, 'Trata', 2022, 3, 15, 'Namerni požig', 'Debeljak', 'rdeči bor', 'S', 493, 'Ravnina', 'Pretežno sončno', 'Mirno ozračje', 'Suho', 0.33),
(317319, 'LJUBLJANA', 457966, 105220, 'Gradišče', 2022, 3, 15, 'Namerni požig', 'Sestoj v obnovi', 'rdeči bor', 'SV', 359, 'Pobočje', 'Pretežno sončno', 'Vetrovno', 'Suho', 0.63),
(317323, 'HRPELJE-KOZINA', 426775, 40837, 'Koritnjak', 2022, 3, 15, 'Kmetijska opravila', 'Mladovje', 'črni bor', 'Z', 749, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.39),
(317341, 'PREBOLD', 508534, 119771, 'Miklavc', 2022, 3, 16, 'Komunikacije (vlaki, el. vodi, itd.)', 'Debeljak', 'navadna bukev', 'Z', 378, 'Pobočje', 'Neznano', 'Močno vetrovno', 'Suho', 0.28),
(317369, 'ROGATEC', 555424, 120740, 'Turk', 2022, 3, 16, 'Obiskovalci gozda (turisti, otroci, ipd.)', 'Debeljak', 'navadna bukev', 'V', 325, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.03),
(317371, 'TREBNJE', 501408, 86904, 'Črna', 2022, 3, 16, 'Namerni požig', 'Debeljak', 'rdeči bor', 'S', 310, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.80),
(317412, 'KOPER', 404280, 48900, 'Fajti', 2022, 3, 17, 'Kmetijska opravila', 'Drogovnjak', 'puhasti hrast', 'J', 133, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.13),
(317475, 'SEŽANA', 414892, 64168, 'Belinca', 2022, 3, 17, 'Kmetijska opravila', 'Sestoj v obnovi', 'puhasti hrast', 'JZ', 338, 'Ravnina', 'Neznano', 'Neznano', 'Suho', 0.14),
(317476, 'SEŽANA', 414273, 63735, 'Dobrava', 2022, 3, 17, 'Kmetijska opravila', 'Drogovnjak', 'puhasti hrast', 'S', 330, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.19),
(317491, 'ILIRSKA BISTRICA', 431030, 42294, 'Velika lipova glavica', 2022, 3, 18, 'Neznani vzroki', 'Drogovnjak', 'navadna bukev', 'S', 572, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.20),
(317538, 'ILIRSKA BISTRICA', 432476, 43086, 'Gošček', 2022, 3, 18, 'Kmetijska opravila', 'Drogovnjak', 'rdeči bor', 'S', 536, 'Vznožje', 'Neznano', 'Neznano', 'Suho', 0.04),
(317574, 'ŠKOFJA LOKA', 444669, 110973, 'Zminec', 2022, 3, 19, 'Neznani vzroki', 'Debeljak', 'navadna bukev', 'Z', 442, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.01),
(317598, 'MIREN-KOSTANJEVICA', 396267, 76338, 'Tabor', 2022, 3, 19, 'Neznani vzroki', 'Panjevec', 'črni gaber', 'JZ', 290, 'Ravnina', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.10),
(317646, 'AJDOVŠČINA', 420789, 82830, 'Trošt', 2022, 3, 20, 'Obiskovalci gozda (turisti, otroci, ipd.)', 'Grmičav gozd', 'črni bor', 'JV', 537, 'Greben', 'Sončno', 'Mirno ozračje', 'Suho', 31.74),
(317649, 'SEŽANA', 409104, 68537, 'Bitnja', 2022, 3, 20, 'Namerni požig', 'Mladovje', 'cer', 'J', 288, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.12),
(317664, 'NOVO MESTO', 513812, 70442, 'Poganški vrh', 2022, 3, 20, 'Namerni požig', 'Sestoj v obnovi', 'navadna smreka', 'S', 222, 'Ravnina', 'Sončno', 'Mirno ozračje', 'Suho', 1.40),
(317692, 'ŠMARTNO PRI LITIJI', 491196, 95317, 'Šrokar', 2022, 3, 21, 'Neznani vzroki', 'Drogovnjak', 'navadna bukev', 'SV', 413, 'Pobočje', 'Sončno', 'Vetrovno', 'Suho', 0.82),
(317749, 'ŠTORE', 523537, 119093, 'Žakelj', 2022, 3, 21, 'Obiskovalci gozda (turisti, otroci, ipd.)', 'Mladovje', 'navadna bukev', 'SV', 416, 'Pobočje', 'Pretežno sončno', 'Mirno ozračje', 'Suho', 0.01),
(317774, 'PIRAN', 389972, 43070, '(Pazzugo)', 2022, 3, 21, 'Kmetijska opravila', 'Debeljak', 'ostali bori', 'SZ', 73, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.01),
(317821, 'TRŽIČ', 446395, 138812, 'Reber', 2022, 3, 22, 'Gozdarska opravila', 'Drogovnjak', 'navadni gaber', 'J', 760, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.35),
(317823, 'ČRNOMELJ', 514774, 48983, 'Mestna loza', 2022, 3, 22, 'Namerni požig', 'Debeljak', 'navadna smreka', 'J', 197, 'Ravnina', 'Sončno', 'Mirno ozračje', 'Suho', 1.26),
(317831, 'PIVKA', 436289, 61496, 'Replje', 2022, 3, 22, 'Neznani vzroki', 'Debeljak', 'rdeči bor', 'V', 576, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.49),
(317833, 'GROSUPLJE', 475728, 90845, 'Spodnje Duplice', 2022, 3, 22, 'Neznani vzroki', 'Sestoj v obnovi', 'navadna bukev', 'SV', 398, 'Pobočje', 'Pretežno sončno', 'Mirno ozračje', 'Suho', 0.13),
(317853, 'LJUBLJANA', 458788, 101839, 'Za Mošenico', 2022, 3, 22, 'Namerni požig', 'Sestoj v obnovi', 'navadna smreka', 'Z', 305, 'Ravnina', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.02),
(317868, 'LJUBLJANA', 459721, 101645, 'Drenikov Vrh', 2022, 3, 23, 'Namerni požig', 'Sestoj v obnovi', 'pravi kostanj', 'SV', 362, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.10),
(317887, 'DOBROVA-POLHOV GRADEC', 451736, 102643, 'Straža', 2022, 3, 23, 'Neznani vzroki', 'Sestoj v obnovi', 'navadna bukev', 'S', 476, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.51),
(317900, 'ŠMARJE PRI JELŠAH', 541206, 126139, 'Sveti Mihael', 2022, 3, 23, 'Kmetijska opravila', 'Debeljak', 'navadna bukev', 'JV', 478, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.67),
(317902, 'DOBROVA-POLHOV GRADEC', 450394, 100022, 'Bezenica', 2022, 3, 23, 'Neznani vzroki', 'Debeljak', 'graden', 'JZ', 427, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.39),
(317904, 'ČRNOMELJ', 514622, 49411, 'Romsko naselje Brajdič', 2022, 3, 23, 'Namerni požig', 'Raznomerno (skupinsko-gnezdasto)', 'navadna smreka', 'SV', 190, 'Ravnina', 'Sončno', 'Mirno ozračje', 'Suho', 0.35),
(317912, 'ŠKOCJAN', 520572, 87725, 'Zagradska gora', 2022, 3, 23, 'Neznani vzroki', 'Raznomerno (skupinsko-gnezdasto)', 'navadna bukev', 'J', 263, 'Pobočje', 'Sončno', 'Vetrovno', 'Suho', 0.41),
(317937, 'PREBOLD', 508545, 119814, 'Burkeljčev hrib', 2022, 3, 23, 'Neznani vzroki', 'Drogovnjak', 'navadna smreka', 'Z', 389, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.02),
(318017, 'ŠENTJUR', 529929, 103680, 'Prapretno', 2022, 3, 24, 'Kmetijska opravila', 'Drogovnjak', 'navadna bukev', 'JV', 541, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.49),
(318027, 'BREZOVICA', 455071, 98411, 'Radna', 2022, 3, 24, 'Obiskovalci gozda (turisti, otroci, ipd.)', 'Sestoj v obnovi', 'navadna bukev', 'J', 345, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 1.20),
(318036, 'ILIRSKA BISTRICA', 440266, 51018, 'Šembije', 2022, 3, 24, 'Kmetijska opravila', 'Drogovnjak', 'robinija', 'V', 538, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.04),
(318039, 'SVETA ANA', 564336, 166405, 'Žugman', 2022, 3, 24, 'Neznani vzroki', 'Debeljak', 'navadna bukev', 'J', 268, 'Vznožje', 'Sončno', 'Mirno ozračje', 'Suho', 0.23),
(318048, 'HRPELJE-KOZINA', 422470, 51283, 'Hrib', 2022, 3, 24, 'Kmetijska opravila', 'Drogovnjak', 'črni bor', 'V', 522, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.07),
(318072, 'ILIRSKA BISTRICA', 440041, 44255, 'Velika Bukovica', 2022, 3, 24, 'Neznani vzroki', 'Drogovnjak', 'cer', 'S', 452, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.01),
(318074, 'LJUBLJANA', 459353, 101611, 'Veliki Rakovnik', 2022, 3, 24, 'Namerni požig', 'Debeljak', 'navadna smreka', 'J', 318, 'Ravnina', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.29),
(318079, 'ILIRSKA BISTRICA', 440495, 44298, 'Velika Bukovica', 2022, 3, 24, 'Neznani vzroki', 'Drogovnjak', 'cer', 'S', 424, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.39),
(318093, 'LJUBLJANA', 459207, 101794, 'Veliki Rakovnik', 2022, 3, 24, 'Namerni požig', 'Debeljak', 'navadna smreka', 'JZ', 316, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.25),
(318126, 'LJUBLJANA', 472143, 101752, 'Stari Grad', 2022, 3, 25, 'Neznani vzroki', 'Drogovnjak', 'rdeči bor', 'SV', 298, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 2.38),
(318153, 'LJUBLJANA', 459319, 101734, 'Veliki Rakovnik', 2022, 3, 25, 'Namerni požig', 'Debeljak', 'navadna smreka', 'J', 324, 'Ravnina', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.57),
(318159, 'VIPAVA', 419899, 78803, 'Stari grad', 2022, 3, 25, 'Neznani vzroki', 'Sestoj v obnovi', 'črni bor', 'JV', 150, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.29),
(318160, 'HRPELJE-KOZINA', 418049, 51686, 'Hrpelje', 2022, 3, 25, 'Kmetijska opravila', 'Mladovje', 'poljski brest', 'Z', 480, 'Ravnina', 'Neznano', 'Neznano', 'Suho', 0.03),
(318188, 'KOPER', 407419, 36345, 'Valica', 2022, 3, 25, 'Neznani vzroki', 'Drogovnjak', 'črni bor', 'S', 366, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.36),
(318201, 'LJUBLJANA', 459228, 101871, 'Veliki Rakovnik', 2022, 3, 25, 'Namerni požig', 'Debeljak', 'navadna smreka', 'Z', 330, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.15),
(318227, 'GROSUPLJE', 476009, 93136, 'Veliki potok', 2022, 3, 26, 'Neznani vzroki', 'Debeljak', 'navadna smreka', 'SV', 361, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.24),
(318233, 'ILIRSKA BISTRICA', 432657, 43046, 'Hrušiške ponikve', 2022, 3, 26, 'Neznani vzroki', 'Drogovnjak', 'rdeči bor', 'S', 519, 'Vznožje', 'Sončno', 'Mirno ozračje', 'Suho', 3.24),
(318242, 'IDRIJA', 416512, 96340, 'Borov vrh', 2022, 3, 26, 'Neznani vzroki', 'Raznomerno (skupinsko-gnezdasto)', 'navadna bukev', 'J', 735, 'Pobočje', 'Sončno', 'Močno vetrovno', 'Suho', 13.95),
(318248, 'MENGEŠ', 465884, 113334, 'Marin hrib', 2022, 3, 26, 'Namerni požig', 'Debeljak', 'rdeči bor', 'JV', 336, 'Pobočje', 'Sončno', 'Vetrovno', 'Suho', 0.35),
(318252, 'ŠMARTNO PRI LITIJI', 488127, 95063, 'Javorje', 2022, 3, 26, 'Neznani vzroki', 'Drogovnjak', 'navadna bukev', 'SV', 562, 'Pobočje', 'Sončno', 'Vetrovno', 'Suho', 0.10),
(318268, 'KAMNIK', 470773, 117980, 'Krajčjek', 2022, 3, 26, 'Neznani vzroki', 'Debeljak', 'rdeči bor', 'SV', 426, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.10),
(318295, 'LJUBLJANA', 458724, 101964, 'Koseze', 2022, 3, 26, 'Namerni požig', 'Debeljak', 'navadna smreka', 'JZ', 302, 'Ravnina', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.53),
(318312, 'ČRNOMELJ', 514685, 49014, 'Romsko naselje Brajdič', 2022, 3, 26, 'Namerni požig', 'Drogovnjak', 'robinija', 'S', 191, 'Ravnina', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.31),
(318316, 'ILIRSKA BISTRICA', 431671, 53229, 'Ostrožno Brdo', 2022, 3, 26, 'Namerni požig', 'Debeljak', 'evropski macesen', 'JV', 626, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.13),
(318350, 'LJUBLJANA', 477733, 97278, 'Šemnikar', 2022, 3, 27, 'Drugo (vojska, ipd.)', 'Drogovnjak', 'rdeči bor', 'JV', 452, 'Pobočje', 'Sončno', 'Vetrovno', 'Suho', 0.11),
(318376, 'GROSUPLJE', 476874, 88573, 'Boršt', 2022, 3, 27, 'Kmetijska opravila', 'Debeljak', 'navadna smreka', 'V', 357, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.09),
(318436, 'HRPELJE-KOZINA', 429267, 45265, 'Gradna', 2022, 3, 28, 'Neznani vzroki', 'Debeljak', 'črni bor', 'JV', 604, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.19),
(318438, 'KAMNIK', 470321, 121385, 'Stahovica', 2022, 3, 28, 'Neznani vzroki', 'Debeljak', 'rdeči bor', 'JV', 426, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.20),
(318462, 'PREDDVOR', 458407, 129532, 'Potoška gora', 2022, 3, 28, 'Neznani vzroki', 'Debeljak', 'navadna bukev', 'V', 636, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 64.26),
(318535, 'ČRNOMELJ', 511361, 42120, 'Grajski pot', 2022, 3, 29, 'Namerni požig', 'Drogovnjak', 'navadni gaber', 'S', 302, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.67),
(318553, 'KANAL', 402862, 106879, 'Višji Dol', 2022, 3, 29, 'Neznani vzroki', 'Pionirski gozd z grmišči', 'navadna lipa', 'V', 741, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.15),
(318562, 'SLOVENSKE KONJICE', 538345, 131319, 'Oplotnica', 2022, 3, 29, 'Neznani vzroki', 'Drogovnjak', 'navadna bukev', 'Z', 282, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.29),
(318586, 'VOJNIK', 524745, 134015, 'Klapen vrh', 2022, 3, 29, 'Neznani vzroki', 'Debeljak', 'navadna bukev', 'J', 538, 'Pobočje', 'Pretežno sončno', 'Zmerno vetrovno', 'Suho', 2.68),
(318596, 'ČRNOMELJ', 512500, 45245, 'Sedališče', 2022, 3, 29, 'Namerni požig', 'Raznomerno (skupinsko-gnezdasto)', 'robinija', 'JZ', 160, 'Ravnina', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.34),
(318606, 'KOČEVJE', 489803, 56631, 'Trata', 2022, 3, 30, 'Namerni požig', 'Debeljak', 'rdeči bor', 'J', 492, 'Ravnina', 'Pretežno sončno', 'Mirno ozračje', 'Suho', 0.07),
(319028, 'GROSUPLJE', 476001, 93158, 'Bičje', 2022, 4, 6, 'Neznani vzroki', 'Debeljak', 'navadna smreka', 'SV', 359, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.92),
(319051, 'ROGAŠKA SLATINA', 550622, 125150, 'Cerovec', 2022, 4, 7, 'Kmetijska opravila', 'Drogovnjak', 'pravi kostanj', 'JV', 565, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.31),
(319062, 'MEŽICA', 489499, 155289, 'Hamun', 2022, 4, 7, 'Kmetijska opravila', 'Sestoj v obnovi', 'navadna smreka', 'V', 658, 'Pobočje', 'Pretežno oblačno', 'Močno vetrovno', 'Suho', 0.48),
(319081, 'GROSUPLJE', 477429, 82652, 'Čušperk', 2022, 4, 7, 'Neznani vzroki', 'Sestoj v obnovi', 'navadna smreka', 'SV', 426, 'Pobočje', 'Pretežno sončno', 'Zmerno vetrovno', 'Suho', 0.61),
(319118, 'MARIBOR', 546062, 160078, 'Kranjc', 2022, 4, 8, 'Neznani vzroki', 'Debeljak', 'pravi kostanj', 'SV', 320, 'Vznožje', 'Pretežno sončno', 'Zmerno vetrovno', 'Suho', 0.17),
(319341, 'DIVAČA', 422378, 59191, 'Brežec pri Divači', 2022, 4, 11, 'Kmetijska opravila', 'Debeljak', 'cer', 'S', 396, 'Ravnina', 'Neznano', 'Neznano', 'Suho', 0.02),
(319431, 'ILIRSKA BISTRICA', 439845, 44105, 'Velika Bukovica', 2022, 4, 13, 'Namerni požig', 'Debeljak', 'cer', 'JV', 428, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.35),
(319501, 'LOGATEC', 439885, 84294, 'Ženček', 2022, 4, 14, 'Neznani vzroki', 'Mladovje', 'navadna smreka', 'JV', 519, 'Vznožje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.82),
(319508, 'JESENICE', 427069, 144656, 'Murova', 2022, 4, 14, 'Neznani vzroki', 'Drogovnjak', 'navadna smreka', 'JZ', 646, 'Greben', 'Pretežno sončno', 'Zmerno vetrovno', 'Suho', 0.15),
(319552, 'KOPER', 413978, 44536, 'Sveta Cecilija', 2022, 4, 15, 'Komunikacije (vlaki, el. vodi, itd.)', 'Grmičav gozd', 'črni bor', 'JZ', 343, 'Pobočje', 'Pretežno sončno', 'Neznano', 'Suho', 0.04),
(319553, 'KOPER', 407556, 45028, 'Hribec', 2022, 4, 15, 'Neznani vzroki', 'Debeljak', 'ostali bori', 'JV', 22, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.06),
(319606, 'ŽALEC', 514891, 127349, 'Pernovo', 2022, 4, 16, 'Obiskovalci gozda (turisti, otroci, ipd.)', 'Debeljak', 'navadna bukev', 'JV', 316, 'Pobočje', 'Sončno', 'Vetrovno', 'Suho', 0.03),
(319612, 'KOMEN', 400335, 74589, 'Ruje', 2022, 4, 16, 'Neznani vzroki', 'Drogovnjak', 'mali jesen', 'S', 209, 'Ravnina', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.03),
(319727, 'KOPER', 419668, 43701, 'Slavnik', 2022, 4, 18, 'Obiskovalci gozda (turisti, otroci, ipd.)', 'Drogovnjak', 'navadna bukev', 'S', 879, 'Pobočje', 'Sončno', 'Močno vetrovno', 'Suho', 0.39),
(319747, 'TRŽIČ', 444438, 132366, 'Zvirče', 2022, 4, 18, 'Neznani vzroki', 'Sestoj v obnovi', 'rdeči bor', 'Ravnina', 505, 'Ravnina', 'Pretežno sončno', 'Vetrovno', 'Suho', 0.01),
(319763, 'KOPER', 406745, 40501, 'Brnica', 2022, 4, 18, 'Kmetijska opravila', 'Drogovnjak', 'puhasti hrast', 'Z', 175, 'Pobočje', 'Sončno', 'Neznano', 'Suho', 0.08),
(319783, 'VRHNIKA', 445000, 95293, 'Moravc', 2022, 4, 19, 'Obiskovalci gozda (turisti, otroci, ipd.)', 'Debeljak', 'graden', 'JV', 389, 'Pobočje', 'Pretežno oblačno', 'Vetrovno', 'Suho', 0.31),
(320133, 'KOPER', 397737, 40545, 'Bandelj', 2022, 4, 28, 'Namerni požig', 'Drogovnjak', 'graden', 'J', 176, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.06),
(320143, 'KOPER', 397733, 40480, 'Bandelj', 2022, 4, 28, 'Namerni požig', 'Mladovje', 'mali jesen', 'J', 165, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.05),
(320240, 'KOMEN', 399332, 71583, 'Bitigonia', 2022, 4, 30, 'Neznani vzroki', 'Drogovnjak', 'graden', 'SV', 170, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.02),
(320244, 'RIBNICA', 478912, 64068, 'Nemška vas', 2022, 4, 30, 'Obiskovalci gozda (turisti, otroci, ipd.)', 'Raznomerno (skupinsko-gnezdasto)', 'rdeči bor', 'J', 488, 'Ravnina', 'Sončno', 'Mirno ozračje', 'Suho', 0.87),
(320279, 'MIREN-KOSTANJEVICA', 397192, 75916, 'Debela griža', 2022, 4, 30, 'Neznani vzroki', 'Drogovnjak', 'graden', 'JV', 271, 'Ravnina', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.32),
(320347, 'GROSUPLJE', 476500, 88836, 'Rudolf', 2022, 5, 1, 'Neznani vzroki', 'Drogovnjak', 'navadna smreka', 'JZ', 382, 'Pobočje', 'Pretežno sončno', 'Zmerno vetrovno', 'Suho', 0.20),
(320695, 'DIVAČA', 428083, 57217, 'Fežnar', 2022, 5, 8, 'Komunikacije (vlaki, el. vodi, itd.)', 'Debeljak', 'črni bor', 'JZ', 406, 'Pobočje', 'Neznano', 'Neznano', 'Neznano', 0.00),
(320855, 'PIRAN', 391924, 40332, 'Nožed', 2022, 5, 12, 'Kmetijska opravila', 'Debeljak', 'črni bor', 'SV', 20, 'Pobočje', 'Sončno', 'Neznano', 'Suho', 0.01),
(321581, 'KOPER', 412397, 39891, 'Gračišče', 2022, 5, 22, 'Neznani vzroki', 'Drogovnjak', 'črni bor', 'V', 293, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.15),
(321593, 'KOPER', 412396, 39890, 'Potok', 2022, 5, 22, 'Neznani vzroki', 'Drogovnjak', 'črni bor', 'V', 293, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.15),
(321603, 'BLOKE', 463725, 75352, 'Špičasti hrib', 2022, 5, 22, 'Neznani vzroki', 'Sestoj v obnovi', 'navadna smreka', 'S', 637, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.10),
(321680, 'PIVKA', 431809, 59702, 'Leskovnice', 2022, 5, 24, 'Komunikacije (vlaki, el. vodi, itd.)', 'Debeljak', 'cer', 'S', 527, 'Ravnina', 'Neznano', 'Neznano', 'Suho', 0.22),
(321965, 'CERKNICA', 454930, 75490, 'Mala Cerkniščica', 2022, 5, 27, 'Kmetijska opravila', 'Sestoj v obnovi', 'rdeči bor', 'JV', 614, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.69),
(322087, 'PIRAN', 389604, 42798, 'Beli Križ', 2022, 5, 28, 'Kmetijska opravila', 'Drogovnjak', 'robinija', 'SV', 59, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.01),
(322839, 'KOMEN', 398715, 74724, 'Ozidje', 2022, 6, 4, 'Neznani vzroki', 'Drogovnjak', 'puhasti hrast', 'JZ', 154, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.06),
(324827, 'SEŽANA', 415418, 63748, 'Podjunčna', 2022, 6, 27, 'Namerni požig', 'Debeljak', 'črni bor', 'J', 362, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.44),
(324866, 'KOPER', 413559, 36672, 'Markinica', 2022, 6, 27, 'Namerni požig', 'Drogovnjak', 'črni bor', 'S', 321, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.15),
(325335, 'NOVA GORICA', 397577, 100401, 'Ponor Zajavor', 2022, 7, 3, 'Neznani vzroki', 'Pionirski gozd z grmišči', 'črni gaber', 'JZ', 566, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.03),
(325424, 'RENČE-VOGRSKO', 396203, 81566, 'Črni hribi', 2022, 7, 3, 'Neznani vzroki', 'Drogovnjak', 'črni bor', 'SV', 206, 'Vznožje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.09),
(325444, 'SEŽANA', 405340, 70881, 'Britih', 2022, 7, 4, 'Namerni požig', 'Panjevec', 'črni gaber', 'V', 258, 'Ravnina', 'Neznano', 'Neznano', 'Suho', 0.10),
(325569, 'KOBARID', 378765, 127383, 'Lepo Brdo', 2022, 7, 5, 'Naravni vzroki (strela)', 'Drogovnjak', 'črni bor', 'V', 967, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.51),
(325735, 'MIREN-KOSTANJEVICA', 398261, 80238, 'Tabor', 2022, 7, 6, 'Naravni vzroki (strela)', 'Debeljak', 'črni bor', 'JV', 487, 'Greben', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.65),
(325802, 'MIREN-KOSTANJEVICA', 398261, 80238, 'Stol', 2022, 7, 7, 'Naravni vzroki (strela)', 'Debeljak', 'črni bor', 'JV', 487, 'Greben', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.65),
(325968, 'KOPER', 417621, 37465, 'Gradež', 2022, 7, 9, 'Neznani vzroki', 'Debeljak', 'črni bor', 'S', 485, 'Greben', 'Sončno', 'Mirno ozračje', 'Suho', 1.03),
(326025, 'KOPER', 419198, 36955, 'Cerje', 2022, 7, 10, 'Namerni požig', 'Panjevec', 'mali jesen', 'SV', 509, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.27),
(326054, 'RENČE-VOGRSKO', 398167, 83267, 'Vrtezovec', 2022, 7, 10, 'Neznani vzroki', 'Panjevec', 'robinija', 'J', 74, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.01),
(326244, 'KOPER', 419545, 37042, 'Cerje', 2022, 7, 13, 'Namerni požig', 'Drogovnjak', 'puhasti hrast', 'JZ', 576, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.04),
(326366, 'KOPER', 407976, 48110, 'Urbanci', 2022, 7, 14, 'Neznani vzroki', 'Drogovnjak', 'puhasti hrast', 'S', 212, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.01),
(326389, 'LJUBLJANA', 459086, 102426, 'Koseški boršt', 2022, 7, 15, 'Namerni požig', 'Debeljak', 'navadna smreka', 'SV', 309, 'Ravnina', 'Neznano', 'Neznano', 'Neznano', 0.00),
(326392, 'PIVKA', 444115, 62896, 'Lipje', 2022, 7, 15, 'Neznani vzroki', 'Drogovnjak', 'črni gaber', 'S', 772, 'Greben', 'Sončno', 'Zmerno vetrovno', 'Suho', 6.08),
(326406, 'MIREN-KOSTANJEVICA', 390993, 81811, 'Ravne njive', 2022, 7, 15, 'Neznani vzroki', 'Drogovnjak', 'črni bor', 'S', 201, 'Greben', 'Sončno', 'Vetrovno', 'Suho', 4.04),
(326475, 'SEŽANA', 401990, 69598, 'Mali vrh', 2022, 7, 16, 'Naravni vzroki (strela)', 'Drogovnjak', 'graden', 'S', 246, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.40),
(326488, 'LJUBLJANA', 458942, 101489, 'Za Mošenico', 2022, 7, 16, 'Namerni požig', 'Debeljak', 'navadna smreka', 'JZ', 303, 'Ravnina', 'Neznano', 'Neznano', 'Neznano', 0.00),
(326691, 'KOPER', 413282, 39488, 'Brgot', 2022, 7, 18, 'Neznani vzroki', 'Drogovnjak', 'puhasti hrast', 'S', 320, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.08),
(326697, 'KOPER', 419649, 44520, 'Grmada', 2022, 7, 18, 'Namerni požig', 'Panjevec', 'črni gaber', 'S', 937, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.26),
(326741, 'HRPELJE-KOZINA', 421076, 49709, 'Ceričje', 2022, 7, 19, 'Neznani vzroki', 'Panjevec', 'črni gaber', 'SZ', 495, 'Ravnina', 'Neznano', 'Neznano', 'Suho', 0.02),
(326761, 'LJUBLJANA', 458787, 101599, 'Veliki Rakovnik', 2022, 7, 19, 'Namerni požig', 'Debeljak', 'navadna smreka', 'SZ', 307, 'Ravnina', 'Neznano', 'Neznano', 'Neznano', 0.00),
(326797, 'MIREN-KOSTANJEVICA', 394177, 79395, 'Goriški kras', 2022, 7, 20, 'Neznani vzroki', 'Panjevec', 'črni bor', 'Ravnina', 15, 'Pobočje', 'Sončno', 'Vetrovno', 'Suho', 2901.91),
(326842, 'KANAL', 389084, 104629, 'Teja', 2022, 7, 20, 'Neznani vzroki', 'Raznomerno (skupinsko-gnezdasto)', 'pravi kostanj', 'SV', 513, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.06),
(326939, 'KOPER', 419733, 44404, 'Grmada', 2022, 7, 21, 'Neznani vzroki', 'Drogovnjak', 'navadna bukev', 'S', 961, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.24),
(326953, 'PIVKA', 434896, 59806, 'Stanišče', 2022, 7, 21, 'Namerni požig', 'Drogovnjak', 'cer', 'JZ', 571, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.09),
(326967, 'KOPER', 400243, 40836, 'Kandelca', 2022, 7, 22, 'Neznani vzroki', 'Drogovnjak', 'črni bor', 'S', 185, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.22),
(326998, 'KOPER', 398210, 43361, 'Kortine', 2022, 7, 22, 'Neznani vzroki', 'Mladovje', 'puhasti hrast', 'SV', 229, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.18),
(327028, 'NOVA GORICA', 402822, 94169, 'Smiti', 2022, 7, 22, 'Neznani vzroki', 'Debeljak', 'navadna bukev', 'JZ', 745, 'Greben', 'Sončno', 'Mirno ozračje', 'Suho', 0.06),
(327070, 'LJUBLJANA', 459779, 102220, 'Mali Rakovnik', 2022, 7, 22, 'Namerni požig', 'Sestoj v obnovi', 'rdeči bor', 'S', 312, 'Pobočje', 'Sončno', 'Neznano', 'Neznano', 0.00),
(327112, 'HRPELJE-KOZINA', 420353, 47507, 'Matarski vrh', 2022, 7, 23, 'Namerni požig', 'Panjevec', 'črni bor', 'V', 731, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 2.40),
(327115, 'HRPELJE-KOZINA', 418634, 53887, 'Dukovce', 2022, 7, 23, 'Namerni požig', 'Debeljak', 'cer', 'S', 539, 'Vznožje', 'Neznano', 'Neznano', 'Suho', 0.04),
(327208, 'PREDDVOR', 458283, 129411, 'Šmarna peč', 2022, 7, 24, 'Naravni vzroki (strela)', 'Drogovnjak', 'črni gaber', 'JZ', 848, 'Pobočje', 'Pretežno oblačno', 'Zmerno vetrovno', 'Nevihta', 0.00),
(327215, 'LJUBLJANA', 459071, 102409, 'Koseze', 2022, 7, 24, 'Namerni požig', 'Debeljak', 'navadna smreka', 'S', 311, 'Ravnina', 'Neznano', 'Neznano', 'Neznano', 0.00),
(327216, 'KOPER', 419036, 44903, 'Grmada', 2022, 7, 24, 'Neznani vzroki', 'Drogovnjak', 'črni bor', 'JZ', 778, 'Pobočje', 'Pretežno sončno', 'Zmerno vetrovno', 'Suho', 0.14),
(327243, 'LJUBLJANA', 466301, 99468, 'Spodnja Hrušica', 2022, 7, 24, 'Namerni požig', 'Debeljak', 'pravi kostanj', 'SV', 324, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.00),
(327265, 'BLED', 431437, 133078, 'Tolsti vrh', 2022, 7, 24, 'Obiskovalci gozda (turisti, otroci, ipd.)', 'Debeljak', 'navadna smreka', 'SZ', 592, 'Pobočje', 'Pretežno sončno', 'Zmerno vetrovno', 'Suho', 0.01),
(327328, 'KOPER', 414445, 36437, 'Risčak', 2022, 7, 25, 'Neznani vzroki', 'Drogovnjak', 'črni gaber', 'JZ', 335, 'Pobočje', 'Pretežno sončno', 'Zmerno vetrovno', 'Suho', 0.67),
(327369, 'KOBARID', 386235, 122804, 'Molida', 2022, 7, 26, 'Naravni vzroki (strela)', 'Panjevec', 'črni gaber', 'S', 453, 'Pobočje', 'Oblačno', 'Zmerno vetrovno', 'Nevihta', 1.94),
(327372, 'KOPER', 413637, 36863, 'Markinica', 2022, 7, 26, 'Neznani vzroki', 'Drogovnjak', 'črni bor', 'SV', 304, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.02),
(327405, 'STRAŽA', 505897, 71415, 'Sveti Tomaž', 2022, 7, 26, 'Naravni vzroki (strela)', 'Raznomerno (skupinsko-gnezdasto)', 'graden', 'JV', 309, 'Pobočje', 'Oblačno', 'Mirno ozračje', 'Nevihta', 0.01),
(327693, 'LJUBLJANA', 458680, 105105, 'Pržanj', 2022, 7, 29, 'Namerni požig', 'Mladovje', 'rdeči bor', 'JZ', 344, 'Pobočje', 'Pretežno oblačno', 'Zmerno vetrovno', 'Suho', 0.04),
(327744, 'PIRAN', 390424, 42900, '(Sant Spirito)', 2022, 7, 30, 'Naravni vzroki (strela)', 'Debeljak', 'ostali bori', 'SV', 143, 'Pobočje', 'Neznano', 'Neznano', 'Nevihta', 0.00),
(327895, 'BLED', 429686, 135949, 'Stan', 2022, 8, 1, 'Neznani vzroki', 'Raznomerno (skupinsko-gnezdasto)', 'rdeči bor', 'S', 523, 'Pobočje', 'Pretežno sončno', 'Zmerno vetrovno', 'Suho', 0.80),
(327950, 'BOHINJ', 418146, 129015, 'Slatovnik', 2022, 8, 2, 'Naravni vzroki (strela)', 'Raznomerno (skupinsko-gnezdasto)', 'črni gaber', 'J', 782, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.01),
(328094, 'LJUBLJANA', 459750, 102268, 'Ljubljana', 2022, 8, 4, 'Namerni požig', 'Sestoj v obnovi', 'rdeči bor', 'SZ', 309, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.00),
(328102, 'ŠKOCJAN', 524679, 84720, 'Zakošnica', 2022, 8, 4, 'Naravni vzroki (strela)', 'Debeljak', 'navadna bukev', 'SV', 190, 'Ravnina', 'Oblačno', 'Močno vetrovno', 'Nevihta', 1.92),
(328196, 'RENČE-VOGRSKO', 397458, 85528, 'Volčja draga', 2022, 8, 5, 'Kmetijska opravila', 'Panjevec', 'robinija', 'JV', 64, 'Vznožje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.16),
(328362, 'SEŽANA', 411340, 58736, 'Bezovščina', 2022, 8, 6, 'Naravni vzroki (strela)', 'Panjevec', 'črni gaber', 'JV', 432, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.04),
(328535, 'KOPER', 410800, 49323, 'Obmejni mejni prehod', 2022, 8, 9, 'Namerni požig', 'Drogovnjak', 'črni bor', 'S', 22, 'Pobočje', 'Sončno', 'Vetrovno', 'Suho', 93.59),
(328545, 'GORENJA VAS-POLJANE', 437811, 102408, 'Bržinova grapa', 2022, 8, 9, 'Neznani vzroki', 'Debeljak', 'navadna smreka', 'SZ', 644, 'Pobočje', 'Sončno', 'Vetrovno', 'Suho', 0.00),
(328561, 'SEŽANA', 409462, 65067, 'Na Puleh', 2022, 8, 9, 'Namerni požig', 'Drogovnjak', 'robinija', 'JV', 332, 'Vznožje', 'Neznano', 'Neznano', 'Suho', 0.18),
(328564, 'DIVAČA', 422439, 62576, 'Gabrk', 2022, 8, 9, 'Namerni požig', 'Drogovnjak', 'črni bor', 'JV', 541, 'Ravnina', 'Neznano', 'Neznano', 'Suho', 0.03),
(328656, 'RADOVLJICA', 439590, 131372, 'Globoko', 2022, 8, 10, 'Komunikacije (vlaki, el. vodi, itd.)', 'Raznomerno (skupinsko-gnezdasto)', 'navadni gaber', 'J', 416, 'Vznožje', 'Sončno', 'Neznano', 'Neznano', 0.18),
(328658, 'ŽALEC', 509346, 126888, 'Martjaki', 2022, 8, 10, 'Kmetijska opravila', 'Debeljak', 'graden', 'V', 356, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.09),
(328660, 'CERKNICA', 450656, 77157, 'Bezuljak', 2022, 8, 10, 'Kmetijska opravila', 'Drogovnjak', 'rdeči bor', 'V', 603, 'Vznožje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.01),
(328686, 'CERKNICA', 450712, 76046, 'Roglji', 2022, 8, 10, 'Kmetijska opravila', 'Drogovnjak', 'rdeči bor', 'Z', 609, 'Vznožje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.01),
(328716, 'RADOVLJICA', 438699, 131440, 'Grafika', 2022, 8, 11, 'Komunikacije (vlaki, el. vodi, itd.)', 'Raznomerno (skupinsko-gnezdasto)', 'navadna smreka', 'JZ', 422, 'Vznožje', 'Sončno', 'Neznano', 'Neznano', 0.58),
(328767, 'KOPER', 412329, 44216, 'Črni Kal', 2022, 8, 11, 'Obiskovalci gozda (turisti, otroci, ipd.)', 'Drogovnjak', 'črni bor', 'JV', 72, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.12),
(329101, 'PIRAN', 391080, 42210, 'Na Prevalu', 2022, 8, 15, 'Namerni požig', 'Debeljak', 'ostali bori', 'SZ', 90, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.04),
(329137, 'RENČE-VOGRSKO', 398336, 83244, 'Lukežiči', 2022, 8, 15, 'Neznani vzroki', 'Panjevec', 'cer', 'JZ', 85, 'Vznožje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.02),
(329321, 'POSTOJNA', 440365, 71822, 'Tiha dolina', 2022, 8, 22, 'Neznani vzroki', 'Sestoj v obnovi', 'navadna bukev', 'SZ', 590, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.00),
(329759, 'LJUBLJANA', 471681, 101575, 'Deben vrh', 2022, 8, 23, 'Neznani vzroki', 'Drogovnjak', 'rdeči bor', 'S', 409, 'Pobočje', 'Sončno', 'Vetrovno', 'Suho', 3.93),
(330073, 'VIPAVA', 426771, 75691, 'Jakcov hrib', 2022, 8, 26, 'Naravni vzroki (strela)', 'Sestoj v obnovi', 'navadna bukev', 'Z', 1038, 'Pobočje', 'Pretežno oblačno', 'Mirno ozračje', 'Suho', 0.75),
(330387, 'SEŽANA', 413386, 57284, 'Karamonke', 2022, 8, 28, 'Namerni požig', 'Drogovnjak', 'črni bor', 'V', 407, 'Pobočje', 'Neznano', 'Neznano', 'Suho', 0.12),
(330421, 'LJUBLJANA', 458762, 101980, 'Koseški boršt', 2022, 8, 29, 'Namerni požig', 'Debeljak', 'rdeči bor', 'JZ', 304, 'Ravnina', 'Neznano', 'Neznano', 'Neznano', 0.00),
(332738, 'KOPER', 405208, 39904, 'Čopinje', 2022, 9, 11, 'Neznani vzroki', 'Panjevec', 'črni bor', 'V', 147, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.01),
(334104, 'PREDDVOR', 459732, 128924, 'Polajnar', 2022, 9, 22, 'Drugo (vojska, ipd.)', 'Debeljak', 'rdeči bor', 'J', 540, 'Pobočje', 'Sončno', 'Zmerno vetrovno', 'Suho', 0.00),
(336320, 'MEŽICA', 490358, 152102, 'Orešnik', 2022, 11, 1, 'Neznani vzroki', 'Drogovnjak', 'rdeči bor', 'J', 615, 'Pobočje', 'Sončno', 'Mirno ozračje', 'Suho', 0.13);
...
('S10_TEST', '1969 TEST', 'Motorcycles', '1:10', 'Min Lin Diecast', 'TEST', 7933, 48.81, 95.70),
...
--
-- Indexes for table `pozari`
--
ALTER TABLE `pozari`
  ADD PRIMARY KEY (`idpozar`);
