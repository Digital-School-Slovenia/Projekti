...
zanka `for` in `range` – poudarek je na delu skozi naloge, kratkih checkpointih in sprotnem testiranju.

## Formalni učni cilji

- Učenec izdela delujoče jedro za sklop »Zanka `for` in `range`«.
...
- delujoče jedro: Izpiši števila od 1 do 10 z `for`.
...
- **Osnovna naloga:** Izpiši števila od 1 do 10 z `for`.
- **Dodatna naloga:** Naredi pravokotnik iz zvezdic.
- **Izziv:** Naredi program, ki izpiše vse delitelje podanega števila.
