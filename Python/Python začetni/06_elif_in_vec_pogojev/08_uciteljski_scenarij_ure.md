# Učiteljski scenarij ure – 06 – `elif`, `else` in več možnosti odločanja
...
- Za hitrejše: Če več kot 10 → `"Ti si uradno mačja oseba 🐱"`.
- Za hitrejše: Če 5-10 → `"Čisto normalno mačje življenje."`
- Izziv: med 21 in 30 °C → "Prijetno vreme ☀️"
- Izziv: med 11 in 20 °C → "Obleci jopico 🧥"
...
- več ločenih `if` namesto smiselne verige `if/elif/else`
- nepokriti robni primeri
- zmeda med `and` in `or`

## Ko se kdo zatakne

- naj najprej napišejo tri testne primere
- vprašaj: ali sta pogoja med seboj izključujoča?
- poudari branje pogojev na glas

## Vprašanja za učitelja

- Kaj je najmanjša stvar, ki mora že delovati? (## Naloge)
- Kateri del glavnega bloka trenutno gradiš? (Če vpiše "da" → "Tudi jaz!")
