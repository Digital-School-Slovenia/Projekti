# Učiteljski scenarij ure – 24 – Turtle – uvod v risanje s funkcijami
...
- Učenec izdela delujoče jedro za sklop »Turtle – uvod v risanje s funkcijami«.
...
- delujoče jedro: `t` je **želva**, ki riše
...
- Kaj je najmanjša stvar, ki mora že delovati? (`t` je **želva**, ki riše)
- Kateri del glavnega bloka trenutno gradiš? (`"black"`, `"yellow"`, `"purple"`)
