# Učiteljski scenarij ure – 05 – Pogoji `if` – osnove odločanja
...
- Učenec izdela delujoče jedro za sklop »Pogoji `if` – osnove odločanja«.
...
- naj najprej napišejo samo pogoj in en `print()`
- vprašaj: kdaj naj se to izvede?
- ne popravljaj cele kode, pokaži samo mesto pogoja
...
- manjka dvopičje
- slaba alineja
- pogoj opisujejo v slovenščini namesto v kodi
