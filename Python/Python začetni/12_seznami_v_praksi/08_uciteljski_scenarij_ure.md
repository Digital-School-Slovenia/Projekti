# Učiteljski scenarij ure – 12 – Seznami v praksi, `for` zanke in mini inventarji
...
Opomba:
- Za hitrejše: "🔴 1 – profesor je znova razočaran"
- Za hitrejše: 😂 **Naloga 6: "Fitnes trener" 🏋️‍♂️**
- Za hitrejše: Če je 0 → "🤨 Nisi se niti premaknil!"
- Izziv: 🏗️ **Naloga 9: "Trgovina 3000 – verzija LIST" 🛒**
- Izziv: Ustvari prazen seznam:
...
- zamenjava med elementom in indeksom
- uporaba neobstoječega indeksa
- prepis elementa namesto dodajanja

## Ko se kdo zatakne

- naj najprej izpišejo cel seznam
- naj izpišejo še en sam element po indeksu
- vprašaj, ali želijo brati, spreminjati ali dodajati

## Vprašanja za učitelja

- Kaj je najmanjša stvar, ki mora že delovati? (november 2025.)
- Kateri del glavnega bloka trenutno gradiš? (😂 **Naloga 3: "Seznam psov v pasjem vrtcu" 🐶**)
