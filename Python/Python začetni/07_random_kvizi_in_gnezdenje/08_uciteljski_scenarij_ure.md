# Učiteljski scenarij ure – 07 – Random, mini kvizi in odločanje v praksi
...
- Učenec izdela delujoče jedro za sklop »Random, mini kvizi in odločanje v praksi«.
...
- naj za test večkrat zaženejo program
- če je pogoj predolg, ga razdelijo na manjše dele
- vprašaj, katera veja kode se v resnici izvede
...
- pozabijo uvoziti `random`
- program se ne odziva, ker testirajo samo en primer
- gnezdenje postane nepregledno
...
- Kaj je najmanjša stvar, ki mora že delovati? (Začetna naloga)
- Kateri del glavnega bloka trenutno gradiš? (Program preverja pravilne odgovore z `if/else` in šteje točke. Pravilni odgovor prinaša 1 točko.)
