# Učiteljski scenarij ure – 18 – Velika delavnica vaj – mešane naloge pred slovarji
...
- Kaj je najmanjša stvar, ki mora že delovati? (`int` → cela števila (`5`, `10`))
- Kateri del glavnega bloka trenutno gradiš? (`bool` → `True` ali `False`)
