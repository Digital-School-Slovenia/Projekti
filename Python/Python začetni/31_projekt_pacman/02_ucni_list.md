...
## Korak 2: Dodaj velikost polja in mapo
...
## Korak 3: Izračunaj velikost okna
...
## Korak 5: Poišči igralca in sovražnika

```python
player_row = player_col = 0
enemy_row = enemy_col = 0
...
## Korak 6: Dodaj funkcije za risanje
...
## Korak 7: Dodaj score in nekaj pomožnih funkcij
...
## Korak 8: Dodaj gibanje sovražnika
