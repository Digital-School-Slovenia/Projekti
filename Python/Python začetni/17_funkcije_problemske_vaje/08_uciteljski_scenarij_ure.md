# Učiteljski scenarij ure – 17 – Ponovitvene vaje – funkcije in problemsko razmišljanje
...
Opomba:
- Za hitrejše: sprejme število sledilcev
- Za hitrejše: glede na število izpiše:
- Za hitrejše: več kot 1000 → "Influencer 😎"
- Izziv: izpiše vse objave
- Izziv: izpiše število objav
...
- funkcijo definirajo, a je ne pokličejo
- zamenjujejo `print()` in `return`
- preveč stvari delajo v eni funkciji

## Ko se kdo zatakne

- naj funkcijo najprej testirajo na enem primeru
- vprašaj: ali želiš izpis ali vrnjeno vrednost?
- če je funkcija dolga, jo razbij

## Vprašanja za učitelja

- Kaj je najmanjša stvar, ki mora že delovati? (🟢 lažje)
- Kateri del glavnega bloka trenutno gradiš? (🟢 Naloga 1: Uporabniško ime)
