# Učiteljski scenarij ure – 30 – Projekt – Dirkalna igra
...
- Dodaj točke ali števec časa.
- Po koncu omogoči nov zagon.
- Omeji igralca na cesto.
- Poskrbi, da se ovira ponovno pojavi na vrhu.
...
- Dodaj stanje `start`, `play`, `game_over`.
- Dodaj težavnostne stopnje.
...
- Kaj je najmanjša stvar, ki mora že delovati? (Nariši travo, cesto in avto.)
- Kateri del glavnega bloka trenutno gradiš? (Dodaj točke ali števec časa.)
