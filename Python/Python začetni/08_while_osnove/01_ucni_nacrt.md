# 08 – Zanka `while` – osnove ponavljanja
...
zanka `while` – osnove ponavljanja – poudarek je na delu skozi naloge, kratkih checkpointih in sprotnem testiranju.
...
- **Dodatna naloga:** Program naj **ponavlja vprašanje**:
- **Izziv:** Naloga:
