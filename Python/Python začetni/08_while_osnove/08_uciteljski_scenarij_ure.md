# Učiteljski scenarij ure – 08 – Zanka `while` – osnove ponavljanja
...
Opomba:
- Za hitrejše: Program naj **ponavlja vprašanje**:
- Za hitrejše: Vsakič, ko uporabnik vnese znesek, ga prištej privarčevanemu denarju.
- Za hitrejše: Program naj izpiše trenutno stanje, na primer:
- Izziv: Naloga:
- Izziv: Uporabi zanko `while`, ki se ponavlja, dokler imata **oba** še več kot 0 HP.
...
- pogoj ustavitve je napačen

## Ko se kdo zatakne

- pred prvo zanko naj napišejo, kdaj se mora ustaviti
- dodaj `print()` za števec
- če se koda zatakne, naj jo poenostavijo na 3 vrstice

## Vprašanja za učitelja

- Kaj je najmanjša stvar, ki mora že delovati? (november 2025.)
- Kateri del glavnega bloka trenutno gradiš? (Naloga 3 - Vsi po pet)
