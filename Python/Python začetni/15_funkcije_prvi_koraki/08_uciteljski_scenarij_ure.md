# Učiteljski scenarij ure – 15 – Funkcije – prvi koraki
...
- Učenec izdela delujoče jedro za sklop »Funkcije – prvi koraki«.
...
- delujoče jedro: Napiši funkcijo `pozdrav(ime)`.
...
- Kaj je najmanjša stvar, ki mora že delovati? (Napiši funkcijo `pozdrav(ime)`.)
- Kateri del glavnega bloka trenutno gradiš? (Napiši funkcijo `kratica(ime, priimek)`.)
