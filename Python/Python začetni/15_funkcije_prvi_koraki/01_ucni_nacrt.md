...
funkcije – prvi koraki – poudarek je na delu skozi naloge, kratkih checkpointih in sprotnem testiranju.
...
- **Osnovna naloga:** Napiši funkcijo `pozdrav(ime)`.
- **Dodatna naloga:** Napiši funkcijo `pozdrav_igralec(ime, level)`.
- **Izziv:** Naredi mini knjižnico petih svojih funkcij.
