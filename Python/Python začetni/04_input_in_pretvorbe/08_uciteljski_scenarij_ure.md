# Učiteljski scenarij ure – 04 – Vnos uporabnika in pretvorba tipov
...
- Učenec izdela delujoče jedro za sklop »Vnos uporabnika in pretvorba tipov«.
...
- naj najprej izpišejo surov vhod
- vprašaj: kakšen tip podatka vrne `input()`?
- pokazati je smiselno eno zelo kratko demonstracijo pretvorbe
...
- pozabijo pretvoriti `input()` v `int()` ali `float()`
- vse vnose obravnavajo kot števila
- pišejo račun neposredno v `print()` brez testiranja
